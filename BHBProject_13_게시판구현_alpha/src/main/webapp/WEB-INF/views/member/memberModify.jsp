...
이름: ${login.username }<br><br>
*비밀번호<input type="text" name="passwd" id="passwd" placeholder="4자리 이상 입력" required="required">
<span id="result3"></span><br>

비빌번호확인<input type="password" name="passwd2" id="passwd2" class="i" required="required">
...
<!-- <div align="center" class="col-1 col-12-mobilep" style="padding-left: 0em;"><h3>@</h3></div>  -->    
       <br>
