 ...
 -->
					<section class="box special features">
						<div class="features-row">
							<section>
							<p><a href="boardNoticeList" style="font-size:23px; font-weight:bold;color:#003458;">공지사항</a></p>
								 <jsp:include page="common/board/boardNotice.jsp" flush="true"></jsp:include>
							</section>
							<section>
							<p><a href="boardLessorList" style="font-size:23px;  font-weight:bold;color:#003458;">정보게시판</a></p>
						...
						<div>
							<section>
								<p style="font-size:23px;  font-weight:bold;color:#003458;">매물리스트</p>
				...
				<footer id="footer">
						...
						<a href="https://github.com/Dantriss/BHB.git" class="icon brands fa-github"><span class="label"></span></a>
