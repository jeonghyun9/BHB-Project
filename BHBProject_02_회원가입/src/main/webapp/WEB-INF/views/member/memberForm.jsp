...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$("#userid").on("keyup", function() { //아이디 중복체크
			$.ajax({
...
*아이디:<input type="text" name="userid" id="userid" placeholder="4자리 이상 입력">
<span id="result"></span>
<br> 
...
<br> 
이름:<input type="text" name="username" id="username" class="i"><br>
<input type="text" name="post" id="sample4_postcode" placeholder="우편번호" class="i">
<input type="button" onclick="sample4_execDaumPostcode()" value="우편번호 찾기"><br>
<input type="text" name="addr1" id="sample4_roadAddress" placeholder="도로명주소" class="i">
<input type="text" name="addr2" id="sample4_jibunAddress" placeholder="지번주소" class="i">
