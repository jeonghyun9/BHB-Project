...
//	@GetMapping("boardLessorList")
	@RequestMapping("boardLessorList")
	public String boardLessorList(Criteria cri, Model model) {
		System.out.println("=========================requestMapping  @");
		Criteria cri1 = new Criteria();
		List<Board_LessorDTO> list=service.getBlList(cri1);
		int total = service.blListTotal(cri);
//		PageVO pageVO = new PageVO(cri, service.blListTotal());
//		pageVO.setTotal(service.blListTotal());
//		pageVO.setPageNum(1);
//		pageVO.setAmount(5);
