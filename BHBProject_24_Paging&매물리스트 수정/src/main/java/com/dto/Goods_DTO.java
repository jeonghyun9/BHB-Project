...
public class Goods_DTO {
   ...
   private int gCode;
	...
	public Goods_DTO(int gCode, int gPrice, int deposit, String address, String location, String area, String room,
			int fee, int floor, String elv, String parking, String build, String gImage1, String lessorid,
			String gImage2, String gImage3, String gImage4, String gImage5) {
		super();
		this.gCode = gCode;
		this.gPrice = gPrice;
	...
	public String toString() {
		return "Goods_YP_DTO [gCode=" + gCode + ", gPrice=" + gPrice + ", deposit=" + deposit + ", address=" + address
