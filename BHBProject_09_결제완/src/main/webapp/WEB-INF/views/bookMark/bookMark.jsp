...
<script>
	$(function(){
        ...
        $("#allCheck1").on("click", function() {
            ...
            $(".selectYP").each(function(idx, data) {
                this.checked= result;
            });
        }); //yp
        ...
        $("#allCheck2").on("click", function() {
            var result= this.checked;
            $(".selectMP").each(function(idx, data) {
                this.checked= result;
            });
        }); //mp
        ...
        $("#delYPCart").on("click", function() {
            ...
            $(".selectYP").each(function(idx, data) {
                 if(this.checked){
                     $("#mpForm").attr("action", "loginCheck/delYPBookMark");
                     $("#mpForm").submit();
                 }
             });
...
<table width="70%" cellspacing="1" cellpadding="1" border="0" >
	...
	<tr>
		...
		<td class="td_default" align="center"><strong>삭제</strong></td>
		<td></td>
	</tr>
...
<c:forEach var="yp" items="${yplist}">
		...
		<tr>
			...
			<input type="checkbox"
				name="check1" id="allCheck1" class="selectYP" 
				value="${yp.num}"></td>
 ...
 <!-- 반복끝 --> 
	...
	<tr>
		<td height="20">
		<button id="delYPCart" class="selectYP">전체 삭제</button>
	</tr>
...
<table width="70%" cellspacing="1" cellpadding="1" border="0" >
	...
	<tr>
		...
		<input type="checkbox" id="allCheck2" class="selectMP"> <strong></strong></td> 
		<td class="td_default" align="center"><strong>매물번호</strong></td>  <!-- gCode -->
		<td class="td_default" align="center"><strong>매물사진</strong></td>  <!-- gImage -->
		<td class="td_default" align="center"><strong>매물정보</strong></td> <!-- address/location -->
...
<c:forEach var="mp" items="${mplist}">
		...
		<tr>
			...
			따라서 value에 삭제할 num값을 설정한다. -->
			<input type="checkbox"
				name="check2" id="allCheck2" class="check2" 
				value="${mp.num}"></td>
 ...
 <!-- 반복끝 --> 
	...
	<tr>
		...
		<button id="delMPCart" class="selectMP">전체 삭제</button>
	</tr>
