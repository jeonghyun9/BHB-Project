...
$(document).ready(function(){
	 ...
	 $("form").on("submit", function (e) {
         ...
         var elv1 = $("#elv1").val();
         var elv2 = $("#elv2").val();
         var parking1 = $("#parking1").val();
         var parking2 = $("#parking2").val();
		 ...
		 if (gImage1.length==0) {
		   ...
		   else if (parking1.length==0 ) { 
		 	 alert("주차 유무를 선택해주세요.")
			 $("#parking1").focus();
			 e.preventDefault();
		 } 
		   else if (parking2.length==0 ) { 
		 	 alert("주차 유무를 선택해주세요.")
			 $("#parking2").focus();
			 e.preventDefault();
		 } 
	 ...
	 <h1 align="center">전세매물 등록화면</h1>
 <section id="main" class="container medium"> 
 <h3>사진 등록</h3>
 
<form action="goodsYPAdd" method="post">
...
<div class="box">
 ...
 <div class="box">
	...
	<tr>
	   <th>전세</th> 
	   <td>
	   	   <input  type="text" class="text" name="gPrice_YP" required="required" id="gPrice_YP" placeholder="만원" />
	 ...
	 <tr>
	 	<th>주소</th>
	 	<td>
	      <input type="text" required="required" name="post" id="sample4_postcode" placeholder="우편번호">
		  <input type="button" onclick="sample4_execDaumPostcode()" value="우편번호 찾기"><br>
		  <input type="text" required="required" name="address"  id="sample4_roadAddress" placeholder="도로명주소">
		  <input type="text" required="required" name="addr2" id="sample4_jibunAddress" placeholder="지번주소">
	...
	<tr>
	 ...
	 <tr>
	   ...
	   <th>관리비</th>
	  	<td>
	  	  <input required="required" type="number" class="text" name="fee" id="fee" placeholder=""/>&nbsp;만원
	  	  </td>
	  	  </tr>
	  <tr>  
	  <th>전용면적</th>
	    <td>    
	      <span class="mb-5" id="AREA">
                <input type="text" required="required" name="area" id="area" placeholder="단위 : m²" />
                        </span>
	  	</td>
	  	</tr>
   ...
   <tr>
       <th>주차</th>
        <td class="col-4 col-12-narrower">
           <input type="radio" name="parking1" value="o" id="parking1"  />
           <label for="parking1">가능</label>
             <input type="radio" name="parking2" value="x" id="parking2" checked/>
      ...
      <tr>
         <th>엘레베이터</th>
              <td class="col-4 col-12-narrower">
                   <input type="radio" name="elv1" value="o" id="elv1">
                   <label for="elv1">있음</label>

                   <input type="radio" name="elv2" value="x" id="elv2" checked>
