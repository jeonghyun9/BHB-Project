...
public class Goods_MP_DTO {
	...
	public Goods_MP_DTO(int gCode, int deposit, int gPrice_MP, String address, String location, String area,
			String room, int fee, int floor, String elv, String parking, String build, String gImage1, String lessorid,
	...
	public String toString() {
		return "Goods_MP_DTO [gCode=" + gCode + ", deposit=" + deposit + ", gPrice_MP=" + gPrice_MP + ", address="
				...
				+ floor + ", elv=" + elv + ", parking=" + parking + ", build=" + build + ", gImage1=" + gImage1
				+ ", lessorid=" + lessorid + ", gImage2=" + gImage2 + ", gImage3=" + gImage3 + ", gImage4=" + gImage4
				+ ", gImage5=" + gImage5 + "]";
	}
