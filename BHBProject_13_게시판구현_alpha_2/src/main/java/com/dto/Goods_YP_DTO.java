...
public class Goods_YP_DTO {
	...
	public Goods_YP_DTO(int gCode, int gPrice_YP, String address, String location, String area, String room, int fee,
			int floor, String elv, String parking, String build, String gImage1, String lessorid, String gImage2,
	...
	public String toString() {
		return "Goods_YP_DTO [gCode=" + gCode + ", gPrice_YP=" + gPrice_YP + ", address=" + address + ", location="
				...
				+ ", parking=" + parking + ", build=" + build + ", gImage1=" + gImage1 + ", lessorid=" + lessorid
				+ ", gImage2=" + gImage2 + ", gImage3=" + gImage3 + ", gImage4=" + gImage4 + ", gImage5=" + gImage5
				+ "]";
	}
