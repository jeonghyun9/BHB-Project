...
<h4>사진 등록</h4>
    ...
    <div class="IMAGE" id="addPhoto">
           <input type="text" name="gImage1" id="gImage1" placeholder="사진1"/><br>
 ...
 <h3>상세정보</h3>
	...
	<tr>
	   <th>전세</th> 
	   <td>
	   	   <input type="text" class="text" name="gPrice_YP" id="gPrice_YP" /> 만원
	   </td>
	   </tr>
	...
	<tr>
		<th>지역정보</th>
		<td class="location">
		<textarea  name="location" id="location" rows="5" cols="45"></textarea>
	 ...
	 <tr>
	   <th>매물유형</th>
         <td>
           <select style="width:180px" name="room" id="room">
	   ...
	   <th>관리비</th>
	  	<td>
	  	  <input type="text" class="text" name="fee" id="fee"/> 만원
	  	  </td>
	  	  </tr>
	  <tr>  
	  <th>평수</th>
	    <td>    
	      <span class="mb-5" id="AREA">
                <input type="text"  name="area" id="area"/> m²
                        </span>
	  	</td>
	  	</tr>
	 ...
	 <tr>
	 	...
	 	<td> 
	 	 ...
	 	 <input type="text" name="floor" id="floor"  /> 층
		</td>
   ...
   <tr>
       <th>주차</th>
        <td class="has-col">
 			 <label><input type="radio" name="parking" value="o" id="parking" /> 가능</label>
             <label><input type="radio" name="parking" value="x" id="parking" checked="checked"/> 없음</label>
		...
		<tr>
			<th>엘레베이터</th>
	    		 <td class="ELV">
                   <label><input type="radio" name="elv" value="o" id="elv"  /> 있음</label>
                   <label><input type="radio" name="elv" value="x" id="elv" checked="checked"/> 없음</label>
				</td>
		</tr>
	<tr>
		<th>준공일자</th>
		<td class="BUILD">
		<input type="text" class="text" name="build" id="build" />
